...
function vw_tour_lite_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Social Icon', 'vw-tour-lite' ),
		'description'   => __( 'Appears on topbar', 'vw-tour-lite' ),
		'id'            => 'social-icon',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
...
function vw_tour_lite_scripts() {
	...
	wp_enqueue_script( 'vw-tour-lite-custom-jquery', get_template_directory_uri() . '/js/custom.js', array('jquery') );
...
define('VW_TOUR_LITE_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-tour-lite/','vw-tour-lite');
define('VW_TOUR_LITE_SUPPORT','https://wordpress.org/support/theme/vw-tour-lite/','vw-tour-lite');
define('VW_TOUR_LITE_REVIEW','https://wordpress.org/support/theme/vw-tour-lite/reviews/','vw-tour-lite');
...
define('VW_TOUR_LITE_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-tour-pro/','vw-tour-lite');
...
define('VW_TOUR_LITE_CREDIT','https://www.vwthemes.com/product/free-vw-tour-theme/','vw-tour-lite');

if ( ! function_exists( 'vw_tour_lite_credit' ) ) {
	function vw_tour_lite_credit(){
		echo "<a href=".esc_url(VW_TOUR_LITE_CREDIT)." target='_blank'>". esc_html__('Tour WordPress Theme','vw-tour-lite')."</a>";
	}
}
...
function vw_tour_lite_sanitize_dropdown_pages( $page_id, $setting ) {
...
/* Excerpt Limit Begin */
function vw_tour_lite_string_limit_words($string, $word_limit) {
...
add_filter('loop_shop_columns', 'vw_tour_lite_loop_columns');
if (!function_exists('vw_tour_lite_loop_columns')) {
	function vw_tour_lite_loop_columns() {
...
require get_template_directory() . '/inc/custom-widgets/social-icon.php';